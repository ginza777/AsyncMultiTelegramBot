...
console.log(modelsConfig.available_text_models); // Output: ["gpt-3.5-turbo", "gpt-3.5-turbo-16k", "gpt-4-1106-preview", "gpt-4", "text-davinci-003"]
console.log(modelsConfig.info["gpt-3.5-turbo"].name); // Output: ChatGPT
console.log(modelsConfig.info["gpt-4"].price_per_1000_output_tokens); // Output: 0.06
